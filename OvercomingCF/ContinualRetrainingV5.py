...
from NN import Net, on_task_update, train_ewc, test, permute_mnist


from scripts import mnist, n_mnist, oversample
from scripts.instances_generator import dset, New_instances_suite_1, New_instances_suite_2, New_instances_suite_3
...
noise_0_X_train, noise_0_X_test = permute_mnist([X_train, X_test],seed=0)

dataset_noise_0 = {}
dataset_noise_0["training_images"] = noise_0_X_train
dataset_noise_0["training_labels"] = Y_train
dataset_noise_0["testing_images"]  = noise_0_X_test
dataset_noise_0["testing_labels"]  = Y_test

# print("X_train.dtype = ", X_train.dtype)
# print("X_train.shape = ", X_train.shape)

# print("X_train2.dtype = ", X_train2.dtype)
...
# 	plt.savefig('batch_orig.png')

# 	img = X_train2[i]
# 	plt.imshow(img.reshape(28, 28), cmap=plt.get_cmap('gray'))
# 	plt.savefig('batch_noise.png')
...
noise_0_digit_0_test_X = noise_0_X_test[np.where(Y_test==0)]
noise_0_digit_1_test_X = noise_0_X_test[np.where(Y_test==1)]
noise_0_digit_2_test_X = noise_0_X_test[np.where(Y_test==2)]
noise_0_digit_3_test_X = noise_0_X_test[np.where(Y_test==3)]
noise_0_digit_4_test_X = noise_0_X_test[np.where(Y_test==4)]
noise_0_digit_5_test_X = noise_0_X_test[np.where(Y_test==5)]
noise_0_digit_6_test_X = noise_0_X_test[np.where(Y_test==6)]
noise_0_digit_7_test_X = noise_0_X_test[np.where(Y_test==7)]
noise_0_digit_8_test_X = noise_0_X_test[np.where(Y_test==8)]
noise_0_digit_9_test_X = noise_0_X_test[np.where(Y_test==9)]
...
for experiment_ID in range(experiments_number):
	...
	num_of_oversamples_per_task = num_of_oversamples
	retraining_sets = New_instances_suite_3(num_of_oversamples_per_task,dataset_noise_0)

	print("len(retraining_sets) = ", len(retraining_sets))

	print("etraining_sets[0].dtype = ", retraining_sets[0].train_X.dtype)
	print("etraining_sets[0].shape = ", retraining_sets[0].train_X.shape)

	for img in retraining_sets[0].train_X:
		plt.imshow(img.reshape(28, 28), cmap=plt.get_cmap('gray'))
		plt.savefig('batch_orig.png')
	...
	if Retraining_flag == True :
		...
		for current_ID in range(n_retraining_sets):
			...
			array_of_tasks_X       = np.array([noise_0_digit_0_test_X,noise_0_digit_1_test_X,noise_0_digit_2_test_X,noise_0_digit_3_test_X,noise_0_digit_4_test_X,noise_0_digit_5_test_X,noise_0_digit_6_test_X,noise_0_digit_7_test_X,noise_0_digit_8_test_X,noise_0_digit_9_test_X])

			array_of_tasks_Y       = np.array([digit_0_test_Y,digit_1_test_Y,digit_2_test_Y,digit_3_test_Y,digit_4_test_Y,digit_5_test_Y,digit_6_test_Y,digit_7_test_Y,digit_8_test_Y,digit_9_test_Y])
			...
			log_acc_digit_0_noise_0.append(test(trained_models[-1], device, noise_0_digit_0_test_X, digit_0_test_Y))
			log_acc_digit_0_noise_0_flag.append(digit_0_noise_0_counter)
			log_acc_digit_1_noise_0.append(test(trained_models[-1], device, noise_0_digit_1_test_X, digit_1_test_Y))
			log_acc_digit_1_noise_0_flag.append(digit_1_noise_0_counter)
			log_acc_digit_2_noise_0.append(test(trained_models[-1], device, noise_0_digit_2_test_X, digit_2_test_Y))
			log_acc_digit_2_noise_0_flag.append(digit_2_noise_0_counter)
			log_acc_digit_3_noise_0.append(test(trained_models[-1], device, noise_0_digit_3_test_X, digit_3_test_Y))
			log_acc_digit_3_noise_0_flag.append(digit_3_noise_0_counter)
			log_acc_digit_4_noise_0.append(test(trained_models[-1], device, noise_0_digit_4_test_X, digit_4_test_Y))
			log_acc_digit_4_noise_0_flag.append(digit_4_noise_0_counter)
			log_acc_digit_5_noise_0.append(test(trained_models[-1], device, noise_0_digit_5_test_X, digit_5_test_Y))
			log_acc_digit_5_noise_0_flag.append(digit_5_noise_0_counter)
			log_acc_digit_6_noise_0.append(test(trained_models[-1], device, noise_0_digit_6_test_X, digit_6_test_Y))
			log_acc_digit_6_noise_0_flag.append(digit_6_noise_0_counter)
			log_acc_digit_7_noise_0.append(test(trained_models[-1], device, noise_0_digit_7_test_X, digit_7_test_Y))
			log_acc_digit_7_noise_0_flag.append(digit_7_noise_0_counter)
			log_acc_digit_8_noise_0.append(test(trained_models[-1], device, noise_0_digit_8_test_X, digit_8_test_Y))
			log_acc_digit_8_noise_0_flag.append(digit_8_noise_0_counter)
			log_acc_digit_9_noise_0.append(test(trained_models[-1], device, noise_0_digit_9_test_X, digit_9_test_Y))
			...
			for re_set in retrained_sets:
				...
				if re_set.noise_type == 0 and re_set.label == 0:
					temp_task_test_X = noise_0_digit_0_test_X
					temp_task_test_Y = digit_0_test_Y
				elif re_set.noise_type == 0 and re_set.label == 1:
					temp_task_test_X = noise_0_digit_1_test_X
					temp_task_test_Y = digit_1_test_Y
				elif re_set.noise_type == 0 and re_set.label == 2:
					temp_task_test_X = noise_0_digit_2_test_X
					temp_task_test_Y = digit_2_test_Y
				elif re_set.noise_type == 0 and re_set.label == 3:
					temp_task_test_X = noise_0_digit_3_test_X
					temp_task_test_Y = digit_3_test_Y
				elif re_set.noise_type == 0 and re_set.label == 4:
					temp_task_test_X = noise_0_digit_4_test_X
					temp_task_test_Y = digit_4_test_Y
				elif re_set.noise_type == 0 and re_set.label == 5:
					temp_task_test_X = noise_0_digit_5_test_X
					temp_task_test_Y = digit_5_test_Y
				elif re_set.noise_type == 0 and re_set.label == 6:
					temp_task_test_X = noise_0_digit_6_test_X
					temp_task_test_Y = digit_6_test_Y
				elif re_set.noise_type == 0 and re_set.label == 7:
					temp_task_test_X = noise_0_digit_7_test_X
					temp_task_test_Y = digit_7_test_Y
				elif re_set.noise_type == 0 and re_set.label == 8:
					temp_task_test_X = noise_0_digit_8_test_X
					temp_task_test_Y = digit_8_test_Y
				elif re_set.noise_type == 0 and re_set.label == 9:
					temp_task_test_X = noise_0_digit_9_test_X
					temp_task_test_Y = digit_9_test_Y
...
file_name1     = "results_combined_16-1.csv"
file_name2     = "results_combined_16-2.csv"
file_name3     = "results_combined_16-3.csv"
