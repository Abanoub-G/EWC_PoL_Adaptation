...
gn_digit_0_train_X = gn_X_train[np.where(gn_Y_train==0)]
gn_digit_1_train_X = gn_X_train[np.where(gn_Y_train==1)]
gn_digit_2_train_X = gn_X_train[np.where(gn_Y_train==2)]
gn_digit_3_train_X = gn_X_train[np.where(gn_Y_train==3)]
gn_digit_4_train_X = gn_X_train[np.where(gn_Y_train==4)]
gn_digit_5_train_X = gn_X_train[np.where(gn_Y_train==5)]
gn_digit_6_train_X = gn_X_train[np.where(gn_Y_train==6)]
gn_digit_7_train_X = gn_X_train[np.where(gn_Y_train==7)]
gn_digit_8_train_X = gn_X_train[np.where(gn_Y_train==8)]
gn_digit_9_train_X = gn_X_train[np.where(gn_Y_train==9)]

gn_digit_0_train_Y = gn_Y_train[np.where(gn_Y_train==0)]
gn_digit_1_train_Y = gn_Y_train[np.where(gn_Y_train==1)]
gn_digit_2_train_Y = gn_Y_train[np.where(gn_Y_train==2)]
gn_digit_3_train_Y = gn_Y_train[np.where(gn_Y_train==3)]
gn_digit_4_train_Y = gn_Y_train[np.where(gn_Y_train==4)]
gn_digit_5_train_Y = gn_Y_train[np.where(gn_Y_train==5)]
gn_digit_6_train_Y = gn_Y_train[np.where(gn_Y_train==6)]
gn_digit_7_train_Y = gn_Y_train[np.where(gn_Y_train==7)]
gn_digit_8_train_Y = gn_Y_train[np.where(gn_Y_train==8)]
gn_digit_9_train_Y = gn_Y_train[np.where(gn_Y_train==9)]
...
blur_digit_0_train_X = blur_X_train[np.where(blur_Y_train==0)]
blur_digit_1_train_X = blur_X_train[np.where(blur_Y_train==1)]
blur_digit_2_train_X = blur_X_train[np.where(blur_Y_train==2)]
blur_digit_3_train_X = blur_X_train[np.where(blur_Y_train==3)]
blur_digit_4_train_X = blur_X_train[np.where(blur_Y_train==4)]
blur_digit_5_train_X = blur_X_train[np.where(blur_Y_train==5)]
blur_digit_6_train_X = blur_X_train[np.where(blur_Y_train==6)]
blur_digit_7_train_X = blur_X_train[np.where(blur_Y_train==7)]
blur_digit_8_train_X = blur_X_train[np.where(blur_Y_train==8)]
blur_digit_9_train_X = blur_X_train[np.where(blur_Y_train==9)]

blur_digit_0_train_Y = blur_Y_train[np.where(blur_Y_train==0)]
blur_digit_1_train_Y = blur_Y_train[np.where(blur_Y_train==1)]
blur_digit_2_train_Y = blur_Y_train[np.where(blur_Y_train==2)]
blur_digit_3_train_Y = blur_Y_train[np.where(blur_Y_train==3)]
blur_digit_4_train_Y = blur_Y_train[np.where(blur_Y_train==4)]
blur_digit_5_train_Y = blur_Y_train[np.where(blur_Y_train==5)]
blur_digit_6_train_Y = blur_Y_train[np.where(blur_Y_train==6)]
blur_digit_7_train_Y = blur_Y_train[np.where(blur_Y_train==7)]
blur_digit_8_train_Y = blur_Y_train[np.where(blur_Y_train==8)]
blur_digit_9_train_Y = blur_Y_train[np.where(blur_Y_train==9)]
...
contrast_digit_0_train_X = contrast_X_train[np.where(contrast_Y_train==0)]
contrast_digit_1_train_X = contrast_X_train[np.where(contrast_Y_train==1)]
contrast_digit_2_train_X = contrast_X_train[np.where(contrast_Y_train==2)]
contrast_digit_3_train_X = contrast_X_train[np.where(contrast_Y_train==3)]
contrast_digit_4_train_X = contrast_X_train[np.where(contrast_Y_train==4)]
contrast_digit_5_train_X = contrast_X_train[np.where(contrast_Y_train==5)]
contrast_digit_6_train_X = contrast_X_train[np.where(contrast_Y_train==6)]
contrast_digit_7_train_X = contrast_X_train[np.where(contrast_Y_train==7)]
contrast_digit_8_train_X = contrast_X_train[np.where(contrast_Y_train==8)]
contrast_digit_9_train_X = contrast_X_train[np.where(contrast_Y_train==9)]


contrast_digit_0_train_Y = contrast_Y_train[np.where(contrast_Y_train==0)]
contrast_digit_1_train_Y = contrast_Y_train[np.where(contrast_Y_train==1)]
contrast_digit_2_train_Y = contrast_Y_train[np.where(contrast_Y_train==2)]
contrast_digit_3_train_Y = contrast_Y_train[np.where(contrast_Y_train==3)]
contrast_digit_4_train_Y = contrast_Y_train[np.where(contrast_Y_train==4)]
contrast_digit_5_train_Y = contrast_Y_train[np.where(contrast_Y_train==5)]
contrast_digit_6_train_Y = contrast_Y_train[np.where(contrast_Y_train==6)]
contrast_digit_7_train_Y = contrast_Y_train[np.where(contrast_Y_train==7)]
contrast_digit_8_train_Y = contrast_Y_train[np.where(contrast_Y_train==8)]
contrast_digit_9_train_Y = contrast_Y_train[np.where(contrast_Y_train==9)]
...
log_acc_digit_0_noise_1_first_model       =  []
log_acc_digit_1_noise_1_first_model       =  []
log_acc_digit_2_noise_1_first_model       =  []
log_acc_digit_3_noise_1_first_model       =  []
log_acc_digit_4_noise_1_first_model       =  []
log_acc_digit_5_noise_1_first_model       =  []
log_acc_digit_6_noise_1_first_model       =  []
log_acc_digit_7_noise_1_first_model       =  []
log_acc_digit_8_noise_1_first_model       =  []
log_acc_digit_9_noise_1_first_model       =  []

log_acc_digit_0_noise_1_last_model       =  []
log_acc_digit_1_noise_1_last_model       =  []
log_acc_digit_2_noise_1_last_model       =  []
log_acc_digit_3_noise_1_last_model       =  []
log_acc_digit_4_noise_1_last_model       =  []
log_acc_digit_5_noise_1_last_model       =  []
log_acc_digit_6_noise_1_last_model       =  []
log_acc_digit_7_noise_1_last_model       =  []
log_acc_digit_8_noise_1_last_model       =  []
log_acc_digit_9_noise_1_last_model       =  []

log_digit_0_noise_1_flag   =  []
log_digit_1_noise_1_flag   =  []
log_digit_2_noise_1_flag   =  []
log_digit_3_noise_1_flag   =  []
log_digit_4_noise_1_flag   =  []
log_digit_5_noise_1_flag   =  []
log_digit_6_noise_1_flag   =  []
log_digit_7_noise_1_flag   =  []
log_digit_8_noise_1_flag   =  []
log_digit_9_noise_1_flag   =  []

log_acc_digit_0_noise_2_first_model       =  []
log_acc_digit_1_noise_2_first_model       =  []
log_acc_digit_2_noise_2_first_model       =  []
log_acc_digit_3_noise_2_first_model       =  []
log_acc_digit_4_noise_2_first_model       =  []
log_acc_digit_5_noise_2_first_model       =  []
log_acc_digit_6_noise_2_first_model       =  []
log_acc_digit_7_noise_2_first_model       =  []
log_acc_digit_8_noise_2_first_model       =  []
log_acc_digit_9_noise_2_first_model       =  []

log_acc_digit_0_noise_2_last_model       =  []
log_acc_digit_1_noise_2_last_model       =  []
log_acc_digit_2_noise_2_last_model       =  []
log_acc_digit_3_noise_2_last_model       =  []
log_acc_digit_4_noise_2_last_model       =  []
log_acc_digit_5_noise_2_last_model       =  []
log_acc_digit_6_noise_2_last_model       =  []
log_acc_digit_7_noise_2_last_model       =  []
log_acc_digit_8_noise_2_last_model       =  []
log_acc_digit_9_noise_2_last_model       =  []

log_digit_0_noise_2_flag   =  []
log_digit_1_noise_2_flag   =  []
log_digit_2_noise_2_flag   =  []
log_digit_3_noise_2_flag   =  []
log_digit_4_noise_2_flag   =  []
log_digit_5_noise_2_flag   =  []
log_digit_6_noise_2_flag   =  []
log_digit_7_noise_2_flag   =  []
log_digit_8_noise_2_flag   =  []
log_digit_9_noise_2_flag   =  []
...
log_acc_all_digits_noise_1_first_model  = []
log_acc_all_digits_noise_1_last_model   = []
log_acc_all_digits_noise_2_first_model  = []
log_acc_all_digits_noise_2_last_model   = []
...
for experiment_ID in range(experiments_number):
	...
	retraining_sets = New_instances_suite_1(n_retraining_sets*10, num_of_oversamples, \
...
# =====================
			...
			log_acc_digit_0_noise_0_first_model.append(test(trained_models[0], device, gn_digit_0_test_X, gn_digit_0_test_Y))
			log_acc_digit_1_noise_0_first_model.append(test(trained_models[0], device, gn_digit_1_test_X, gn_digit_1_test_Y))
			log_acc_digit_2_noise_0_first_model.append(test(trained_models[0], device, gn_digit_2_test_X, gn_digit_2_test_Y))
			log_acc_digit_3_noise_0_first_model.append(test(trained_models[0], device, gn_digit_3_test_X, gn_digit_3_test_Y))
			log_acc_digit_4_noise_0_first_model.append(test(trained_models[0], device, gn_digit_4_test_X, gn_digit_4_test_Y))
			log_acc_digit_5_noise_0_first_model.append(test(trained_models[0], device, gn_digit_5_test_X, gn_digit_5_test_Y))
			log_acc_digit_6_noise_0_first_model.append(test(trained_models[0], device, gn_digit_6_test_X, gn_digit_6_test_Y))
			log_acc_digit_7_noise_0_first_model.append(test(trained_models[0], device, gn_digit_7_test_X, gn_digit_7_test_Y))
			log_acc_digit_8_noise_0_first_model.append(test(trained_models[0], device, gn_digit_8_test_X, gn_digit_8_test_Y))
			log_acc_digit_9_noise_0_first_model.append(test(trained_models[0], device, gn_digit_9_test_X, gn_digit_9_test_Y))

			log_acc_digit_0_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_0_test_X, gn_digit_0_test_Y))
			log_acc_digit_1_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_1_test_X, gn_digit_1_test_Y))
			log_acc_digit_2_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_2_test_X, gn_digit_2_test_Y))
			log_acc_digit_3_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_3_test_X, gn_digit_3_test_Y))
			log_acc_digit_4_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_4_test_X, gn_digit_4_test_Y))
			log_acc_digit_5_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_5_test_X, gn_digit_5_test_Y))
			log_acc_digit_6_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_6_test_X, gn_digit_6_test_Y))
			log_acc_digit_7_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_7_test_X, gn_digit_7_test_Y))
			log_acc_digit_8_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_8_test_X, gn_digit_8_test_Y))
			log_acc_digit_9_noise_0_last_model.append(test(trained_models[-1], device, gn_digit_9_test_X, gn_digit_9_test_Y))
			...
			log_acc_digit_0_noise_1_first_model.append(test(trained_models[0], device, blur_digit_0_test_X, blur_digit_0_test_Y))
			log_acc_digit_1_noise_1_first_model.append(test(trained_models[0], device, blur_digit_1_test_X, blur_digit_1_test_Y))
			log_acc_digit_2_noise_1_first_model.append(test(trained_models[0], device, blur_digit_2_test_X, blur_digit_2_test_Y))
			log_acc_digit_3_noise_1_first_model.append(test(trained_models[0], device, blur_digit_3_test_X, blur_digit_3_test_Y))
			log_acc_digit_4_noise_1_first_model.append(test(trained_models[0], device, blur_digit_4_test_X, blur_digit_4_test_Y))
			log_acc_digit_5_noise_1_first_model.append(test(trained_models[0], device, blur_digit_5_test_X, blur_digit_5_test_Y))
			log_acc_digit_6_noise_1_first_model.append(test(trained_models[0], device, blur_digit_6_test_X, blur_digit_6_test_Y))
			log_acc_digit_7_noise_1_first_model.append(test(trained_models[0], device, blur_digit_7_test_X, blur_digit_7_test_Y))
			log_acc_digit_8_noise_1_first_model.append(test(trained_models[0], device, blur_digit_8_test_X, blur_digit_8_test_Y))
			log_acc_digit_9_noise_1_first_model.append(test(trained_models[0], device, blur_digit_9_test_X, blur_digit_9_test_Y))

			log_acc_digit_0_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_0_test_X, blur_digit_0_test_Y))
			log_acc_digit_1_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_1_test_X, blur_digit_1_test_Y))
			log_acc_digit_2_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_2_test_X, blur_digit_2_test_Y))
			log_acc_digit_3_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_3_test_X, blur_digit_3_test_Y))
			log_acc_digit_4_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_4_test_X, blur_digit_4_test_Y))
			log_acc_digit_5_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_5_test_X, blur_digit_5_test_Y))
			log_acc_digit_6_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_6_test_X, blur_digit_6_test_Y))
			log_acc_digit_7_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_7_test_X, blur_digit_7_test_Y))
			log_acc_digit_8_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_8_test_X, blur_digit_8_test_Y))
			log_acc_digit_9_noise_1_last_model.append(test(trained_models[-1], device, blur_digit_9_test_X, blur_digit_9_test_Y))

			log_digit_0_noise_1_flag.append(digit_0_noise_1_counter)
			log_digit_1_noise_1_flag.append(digit_1_noise_1_counter)
			log_digit_2_noise_1_flag.append(digit_2_noise_1_counter)
			log_digit_3_noise_1_flag.append(digit_3_noise_1_counter)
			log_digit_4_noise_1_flag.append(digit_4_noise_1_counter)
			log_digit_5_noise_1_flag.append(digit_5_noise_1_counter)
			log_digit_6_noise_1_flag.append(digit_6_noise_1_counter)
			log_digit_7_noise_1_flag.append(digit_7_noise_1_counter)
			log_digit_8_noise_1_flag.append(digit_8_noise_1_counter)
			log_digit_9_noise_1_flag.append(digit_9_noise_1_counter)

			log_acc_digit_0_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_0_test_X, contrast_digit_0_test_Y))
			log_acc_digit_1_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_1_test_X, contrast_digit_1_test_Y))
			log_acc_digit_2_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_2_test_X, contrast_digit_2_test_Y))
			log_acc_digit_3_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_3_test_X, contrast_digit_3_test_Y))
			log_acc_digit_4_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_4_test_X, contrast_digit_4_test_Y))
			log_acc_digit_5_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_5_test_X, contrast_digit_5_test_Y))
			log_acc_digit_6_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_6_test_X, contrast_digit_6_test_Y))
			log_acc_digit_7_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_7_test_X, contrast_digit_7_test_Y))
			log_acc_digit_8_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_8_test_X, contrast_digit_8_test_Y))
			log_acc_digit_9_noise_2_first_model.append(test(trained_models[0], device, contrast_digit_9_test_X, contrast_digit_9_test_Y))

			log_acc_digit_0_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_0_test_X, contrast_digit_0_test_Y))
			log_acc_digit_1_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_1_test_X, contrast_digit_1_test_Y))
			log_acc_digit_2_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_2_test_X, contrast_digit_2_test_Y))
			log_acc_digit_3_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_3_test_X, contrast_digit_3_test_Y))
			log_acc_digit_4_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_4_test_X, contrast_digit_4_test_Y))
			log_acc_digit_5_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_5_test_X, contrast_digit_5_test_Y))
			log_acc_digit_6_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_6_test_X, contrast_digit_6_test_Y))
			log_acc_digit_7_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_7_test_X, contrast_digit_7_test_Y))
			log_acc_digit_8_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_8_test_X, contrast_digit_8_test_Y))
			log_acc_digit_9_noise_2_last_model.append(test(trained_models[-1], device, contrast_digit_9_test_X, contrast_digit_9_test_Y))

			log_digit_0_noise_2_flag.append(digit_0_noise_2_counter)
			log_digit_1_noise_2_flag.append(digit_1_noise_2_counter)
			log_digit_2_noise_2_flag.append(digit_2_noise_2_counter)
			log_digit_3_noise_2_flag.append(digit_3_noise_2_counter)
			log_digit_4_noise_2_flag.append(digit_4_noise_2_counter)
			log_digit_5_noise_2_flag.append(digit_5_noise_2_counter)
			log_digit_6_noise_2_flag.append(digit_6_noise_2_counter)
			log_digit_7_noise_2_flag.append(digit_7_noise_2_counter)
			log_digit_8_noise_2_flag.append(digit_8_noise_2_counter)
			log_digit_9_noise_2_flag.append(digit_9_noise_2_counter)
			...
			log_acc_all_digits_noise_0_first_model.append(test(trained_models[0], device, gn_X_test, gn_Y_test))
			log_acc_all_digits_noise_0_last_model.append(test(trained_models[-1], device, gn_X_test, gn_Y_test))
			log_acc_all_digits_noise_1_first_model.append(test(trained_models[0], device, blur_X_test, blur_Y_test))
			log_acc_all_digits_noise_1_last_model.append(test(trained_models[-1], device, blur_X_test, blur_Y_test))
			log_acc_all_digits_noise_2_first_model.append(test(trained_models[0], device, contrast_X_test, contrast_Y_test))
			log_acc_all_digits_noise_2_last_model.append(test(trained_models[-1], device, contrast_X_test, contrast_Y_test))
...
file_name1     = "results_combined_124-1.csv"
file_name2     = "results_combined_124-2.csv"
file_name3     = "results_combined_124-3.csv"
...
\
					acc_digit_0_noise_1_first_model,\
					acc_digit_1_noise_1_first_model,\
					acc_digit_2_noise_1_first_model,\
					acc_digit_3_noise_1_first_model,\
					acc_digit_4_noise_1_first_model,\
					acc_digit_5_noise_1_first_model,\
					acc_digit_6_noise_1_first_model,\
					acc_digit_7_noise_1_first_model,\
					acc_digit_8_noise_1_first_model,\
					acc_digit_9_noise_1_first_model,\
\
					acc_digit_0_noise_1_last_model,\
					acc_digit_1_noise_1_last_model,\
					acc_digit_2_noise_1_last_model,\
					acc_digit_3_noise_1_last_model,\
					acc_digit_4_noise_1_last_model,\
					acc_digit_5_noise_1_last_model,\
					acc_digit_6_noise_1_last_model,\
					acc_digit_7_noise_1_last_model,\
					acc_digit_8_noise_1_last_model,\
					acc_digit_9_noise_1_last_model,\
\
					acc_digit_0_noise_2_first_model,\
					acc_digit_1_noise_2_first_model,\
					acc_digit_2_noise_2_first_model,\
					acc_digit_3_noise_2_first_model,\
					acc_digit_4_noise_2_first_model,\
					acc_digit_5_noise_2_first_model,\
					acc_digit_6_noise_2_first_model,\
					acc_digit_7_noise_2_first_model,\
					acc_digit_8_noise_2_first_model,\
					acc_digit_9_noise_2_first_model,\
\
					acc_digit_0_noise_2_last_model,\
					acc_digit_1_noise_2_last_model,\
					acc_digit_2_noise_2_last_model,\
					acc_digit_3_noise_2_last_model,\
					acc_digit_4_noise_2_last_model,\
					acc_digit_5_noise_2_last_model,\
					acc_digit_6_noise_2_last_model,\
					acc_digit_7_noise_2_last_model,\
					acc_digit_8_noise_2_last_model,\
					acc_digit_9_noise_2_last_model,\
\
...
\
					acc_digit_0_noise_1_flag,\
					acc_digit_1_noise_1_flag,\
					acc_digit_2_noise_1_flag,\
					acc_digit_3_noise_1_flag,\
					acc_digit_4_noise_1_flag,\
					acc_digit_5_noise_1_flag,\
					acc_digit_6_noise_1_flag,\
					acc_digit_7_noise_1_flag,\
					acc_digit_8_noise_1_flag,\
					acc_digit_9_noise_1_flag,\
\
					acc_digit_0_noise_2_flag,\
					acc_digit_1_noise_2_flag,\
					acc_digit_2_noise_2_flag,\
					acc_digit_3_noise_2_flag,\
					acc_digit_4_noise_2_flag,\
					acc_digit_5_noise_2_flag,\
					acc_digit_6_noise_2_flag,\
					acc_digit_7_noise_2_flag,\
					acc_digit_8_noise_2_flag,\
					acc_digit_9_noise_2_flag,\
\
					...
					acc_all_digits_noise_1_first_model,\
					acc_all_digits_noise_1_last_model,\
					acc_all_digits_noise_2_first_model,\
					acc_all_digits_noise_2_last_model,\
					\n')
	...
	for i in range(len(log_current_ID_array)):
		log_file.write('%d,%d,%d,%d,\
					...
					log_acc_digit_0_noise_1_first_model[i],\
					log_acc_digit_1_noise_1_first_model[i],\
					log_acc_digit_2_noise_1_first_model[i],\
					log_acc_digit_3_noise_1_first_model[i],\
					log_acc_digit_4_noise_1_first_model[i],\
					log_acc_digit_5_noise_1_first_model[i],\
					log_acc_digit_6_noise_1_first_model[i],\
					log_acc_digit_7_noise_1_first_model[i],\
					log_acc_digit_8_noise_1_first_model[i],\
					log_acc_digit_9_noise_1_first_model[i],\

					log_acc_digit_0_noise_1_last_model[i],\
					log_acc_digit_1_noise_1_last_model[i],\
					log_acc_digit_2_noise_1_last_model[i],\
					log_acc_digit_3_noise_1_last_model[i],\
					log_acc_digit_4_noise_1_last_model[i],\
					log_acc_digit_5_noise_1_last_model[i],\
					log_acc_digit_6_noise_1_last_model[i],\
					log_acc_digit_7_noise_1_last_model[i],\
					log_acc_digit_8_noise_1_last_model[i],\
					log_acc_digit_9_noise_1_last_model[i],\

					log_acc_digit_0_noise_2_first_model[i],\
					log_acc_digit_1_noise_2_first_model[i],\
					log_acc_digit_2_noise_2_first_model[i],\
					log_acc_digit_3_noise_2_first_model[i],\
					log_acc_digit_4_noise_2_first_model[i],\
					log_acc_digit_5_noise_2_first_model[i],\
					log_acc_digit_6_noise_2_first_model[i],\
					log_acc_digit_7_noise_2_first_model[i],\
					log_acc_digit_8_noise_2_first_model[i],\
					log_acc_digit_9_noise_2_first_model[i],\

					log_acc_digit_0_noise_2_last_model[i],\
					log_acc_digit_1_noise_2_last_model[i],\
					log_acc_digit_2_noise_2_last_model[i],\
					log_acc_digit_3_noise_2_last_model[i],\
					log_acc_digit_4_noise_2_last_model[i],\
					log_acc_digit_5_noise_2_last_model[i],\
					log_acc_digit_6_noise_2_last_model[i],\
					log_acc_digit_7_noise_2_last_model[i],\
					log_acc_digit_8_noise_2_last_model[i],\
					log_acc_digit_9_noise_2_last_model[i],\
					...
					log_digit_0_noise_1_flag[i],\
					log_digit_1_noise_1_flag[i],\
					log_digit_2_noise_1_flag[i],\
					log_digit_3_noise_1_flag[i],\
					log_digit_4_noise_1_flag[i],\
					log_digit_5_noise_1_flag[i],\
					log_digit_6_noise_1_flag[i],\
					log_digit_7_noise_1_flag[i],\
					log_digit_8_noise_1_flag[i],\
					log_digit_9_noise_1_flag[i],\

					log_digit_0_noise_2_flag[i],\
					log_digit_1_noise_2_flag[i],\
					log_digit_2_noise_2_flag[i],\
					log_digit_3_noise_2_flag[i],\
					log_digit_4_noise_2_flag[i],\
					log_digit_5_noise_2_flag[i],\
					log_digit_6_noise_2_flag[i],\
					log_digit_7_noise_2_flag[i],\
					log_digit_8_noise_2_flag[i],\
					log_digit_9_noise_2_flag[i],\
					...
					log_acc_all_digits_noise_1_first_model[i],\
					log_acc_all_digits_noise_1_last_model[i],\
					log_acc_all_digits_noise_2_first_model[i],\
					log_acc_all_digits_noise_2_last_model[i]))
